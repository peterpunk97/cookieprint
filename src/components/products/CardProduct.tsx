...
export const CardProduct = ({
    ...
    //identificar variante segun color activo
    ...
    return (<div className="flex flex-col gap-6 relative">
            ...
            <div className="flex gap-3">
                {
                    colors.map(color => (
                        <span
                            key={color.color} className={`grid place-items-center w-5 h-5 rounded-full cursor-pointer`}>
        ...
        <div className="absolue top-2 left-2">
            {
