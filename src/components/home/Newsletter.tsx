export const Newsletter = () => {
    return (
        ...
        <div
          ...
          style={{ backgroundImage: 'url(/img/img-newsletterpng.png)' }}
        />
        ...
        <div className="container z-10 relative p-5 md:p-0">
            <div className="w-full text-black bg-white p-12 space-y-5 md:w[50%] lg:w-[40%]">
                <p className="text-xs uppercase font-bold">
                    Suscríbete a nuestrro boletín y recibe promociones exclusivas
                </p>
                <p className="text-xs font-medium w-[80%] leading-5">
                    Introduce tu Whatsapp para recibir ofertas
                </p>
                <form className="flex flex-col gap-5 xl:flex-row">
                    <input type="tel" className="border boder-slate-200 focus:outline-none 
                    rounded-full py-3 px-5 w-full text-xsfont-medium" placeholder="Ingresa tu número aquí" />
